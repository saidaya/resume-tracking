...
MAPPING_NAME_URL = {
    "SKILL_DB": "skill_db_relax_20.json",
    "TOKEN_DIST": "token_dist.json"
}
...
class RemoteBucket:
    ...
    def __init__(
        ...
        # construct endpoint
        self.end_point = f"https://raw.githubusercontent.com/saidaya/resume-tracking/{self.branch}"
        return
    ...
    def fetch_remote(
        ...
        Examples
        --------
        >>> from src.network.remote_db import RemoteBucket
